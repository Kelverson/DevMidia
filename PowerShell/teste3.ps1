...
$matriz = @(
    @("consultor.tecnico","Consultor Técnico", "Consultoria Técnica", $null),
    @("kelverson.silva","Kelverson Aparecido da Silva", 'Tecnologia da Informação', "167"),
    @("felipe.miura","Felipe Seite Miura", "Tecnologia da Informação", "180"),
    @("lucas.kayano","Lucas Kayano", "Projetos", "201"),
    @("marcella.inacio", "Marcella Maia Inacio ", "Projetos", "124"),
    @("vinicius.fanton","Vinicius Fanton", "Projetos", "124")
    
    
)

$usuario = "consultor.tecnico"
#$matriz[0]
...
for ($i = 0; $i -lt 6; $i++) {
    ...
    $i
    if($usuario -eq $matriz[$i][0]){

        $matriz[$i]

        $name = $matriz[$i][1] 
        $departamento = $matriz[$i][2]
        $testeRamal = $matriz[$i][3]
        $email = $matriz[$i][0] + "@newline.ind.br"

    }
}
$usuario = 'kelverson.silva'

$telefone = "11 4751-6350"
$end = "Rua Sônia, 101 - Jardim Aeródromo Internacional"
$cidade = "Suzano"
$est = "SP"
$cep = "08616-520"
$country = "Brazil"
...
<body style='line-height:99%;'>
  ...
  <div>
    ...
    <br>
      ...
      <p class="font1">Sites: <a href="www.newline.ind.br" style='line-height:90%; font-size:14px; text-decoration:none; color: blue' ><span>www.newline.ind.br</span></a></p><br>
      ...
      <p>
        <a style='font-size:11.0pt;line-height:90%;font-family:"Calibri",sans-serif;font-style:normal;text-decoration:none;color: blue' href="https://www.linkedin.com/company/newline-iluminacao/mycompany/" title="Our LinkedIn">Linkedin</a>
          | <a style='font-size:11.0pt;line-height:90%;font-family:"Calibri",sans-serif;font-style:normal;text-decoration:none;color: blue' href="https://www.instagram.com/newlineiluminacao/" title="Follow Us">Instagram</a>
          | <a style='font-size:11.0pt;line-height:90%;font-family:"Calibri",sans-serif;font-style:normal;text-decoration:none;color: blue' href="https://www.youtube.com/channel/UCfs6kfPWUrYyJu1e7IIfErw" title="Subscribe Us">YouTube</a>
          | <a style='font-size:11.0pt;line-height:90%;font-family:"Calibri",sans-serif;font-style:normal;text-decoration:none;color: blue' href="https://www.facebook.com/newlineiluminacao" title="Be Social">Facebook</a>
      </p>
    <br>
  </div>
</body>
